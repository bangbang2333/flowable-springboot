package com.haiyang.flowablespringboot.wellsoft;
...
public class ProcessTess {
    ...
    public void deployProcess() {
        ...
        Deployment deployment = repositoryService.createDeployment()
                .name("运策量子请假流程")
                .key("wellsoft_holiday")
                .addClasspathResource("wellsoft_holiday.bpmn20.xml")
                .deploy();
    ...
    public void claimTask() {
        ...
        log.info("任务拾取成功，拾取人：{}", a);
    }

    @Test
    public void claimTask1() {
        TaskService taskService = getProcessEngine().getTaskService();
        String a = "刘军";
        Task task = taskService.createTaskQuery().taskCandidateUser(a).singleResult();
        log.info("任务的id是：{}", task.getId());
